...
// Exercise media from upstream CDN (same dataset openGym uses in mobile/demo builds).
// See NOTICE.md — images/animations are third-party; metadata is MIT.
const CDN =
  'https://cdn.jsdelivr.net/gh/hasaneyldrm/exercises-dataset@7455efae41b330c265e7cd4b78dfa848e7ce5ebd'
const IMG_BASE = `${CDN}/images/`
const GIF_BASE = `${CDN}/videos/`
