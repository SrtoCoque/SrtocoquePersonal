...
export function MediaScrollRow({
  ...
  return (
    <div
      className={cn(
        "-mx-4 flex gap-3 overflow-x-auto px-4 pb-1 sm:-mx-6 sm:gap-4 sm:px-6",
    ...
    >
      {Children.map(children, (child) =>
        child == null ? null : (
          <div className="w-[42vw] max-w-[148px] shrink-0 snap-start sm:w-[136px] sm:max-w-none md:w-[148px] [&>*]:h-full [&>*]:w-full">
            {child}
          </div>
        ),
      )}
